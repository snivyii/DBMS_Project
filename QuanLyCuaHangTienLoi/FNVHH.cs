...
{
    public partial class FNVHH : Form
    {
        ...
        private void FNVHH_Paint(object sender, PaintEventArgs e)
        {
            FormRegionAndBorder(this, 20, e.Graphics, Color.FromArgb(241, 242, 246), 2);
        }

        private void FNVHH_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
