...
{
    public partial class FNVTN : Form
    {
        ...
        private void FNVTN_Paint(object sender, PaintEventArgs e)
        {
            FormRegionAndBorder(this, 20, e.Graphics, Color.FromArgb(241, 242, 246), 2);
        }

        private void FNVTN_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
